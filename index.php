...
<script>
    var targets = {
        'https://vesti.ru/': {number_of_requests: 0, number_of_errored_responses: 0},
        'https,://rian.ru/': {number_of_requests: 0, number_of_errored_responses: 0},
        'https://lenta.ru/': {number_of_requests: 0, number_of_errored_responses: 0},
        'https://aif.ru/': {number_of_requests: 0, number_of_errored_responses: 0},
        ...
        'https://vz.ru/': {number_of_requests: 0, number_of_errored_responses: 0},
